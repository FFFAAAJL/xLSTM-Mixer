...
echo ============================================
echo Starting All Sparsity Experiments
echo ============================================
echo.
...
echo ----------------------------------------
call "%~dp0run_electricity_tasks_no_pruning.bat"
if %errorlevel% neq 0 (
...
echo ----------------------------------------
call "%~dp0run_electricity_tasks_fss_2_4.bat"
if %errorlevel% neq 0 (
...
echo ----------------------------------------
call "%~dp0run_electricity_tasks_fss_1_4.bat"
if %errorlevel% neq 0 (
...
echo ----------------------------------------
call "%~dp0run_electricity_tasks_fss_4_8.bat"
if %errorlevel% neq 0 (
...
echo ----------------------------------------
call "%~dp0run_electricity_tasks_fss_2_8.bat"
if %errorlevel% neq 0 (
...
:: ============================================
:: 实验6: 高稀疏模式（1:64，约98.44%）
:: ============================================
echo [6/6] Running High Sparsity (1:64, ~98.44%%)...
echo ----------------------------------------
call "%~dp0run_electricity_tasks_fss_1_64.bat"
if %errorlevel% neq 0 (
    echo ERROR: Experiment 6 ^(High Sparsity, 1:64^) failed
    pause
    exit /b %errorlevel%
)
...
echo   - High Sparsity (approx 1:64, bank_size=64)
echo.
