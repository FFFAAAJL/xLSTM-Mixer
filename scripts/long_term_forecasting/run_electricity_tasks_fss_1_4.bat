...
:: === Config: pred_len=96 (FSS 1:4 Sparsity 75% Seed 42) ===
:: 1:4模式：每4个元素保留1个，稀疏度75%
echo Running seed 42 (pred_len=96, FSS 1:4 sparsity)...
python -m xlstm_mixer fit+test ^
    ...
    --trainer.logger.name Electricity_xlstm-mixer_96_42_FSS_1_4 ^
...
echo All FSS tasks (1:4 sparsity, Seed 42) completed successfully.
pause
