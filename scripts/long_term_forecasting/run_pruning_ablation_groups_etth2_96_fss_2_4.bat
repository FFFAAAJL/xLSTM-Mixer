...
echo.
echo === ETTh2 pruning ablation (pred_len=96, seed=42, bank_size=4, target_sparsity=0.5) ===
echo Groups:
...
:: -------------------- Group 5 --------------------
echo Running G5 all...
python -m xlstm_mixer fit+test --data ForecastingTSLibDataModule --data.dataset_name ETTh2 --data.root_path "E:\LSTM\xLSTM-Mixer-main\xLSTM-Mixer\common-ts\datasets\tslib_datasets" --data.num_workers 0 --optimizer.lr 0.001 --data.seq_len 768 --data.pred_len 96 --data.label_len 0 --data.batch_size 128 --model LongTermForecastingExp --model.criterion torch.nn.L1Loss --model.architecture xLSTMMixer --model.architecture.num_mem_tokens 1 --model.architecture.xlstm_num_heads 8 --model.architecture.xlstm_num_blocks 1 --model.architecture.xlstm_embedding_dim 128 --model.architecture.xlstm_conv1d_kernel_size 0 --model.architecture.xlstm_dropout 0.1 --lr_scheduler.constant_gamma_epochs 2 --lr_scheduler.gamma 0.98 --lr_scheduler.cosine_epochs 15 --lr_scheduler.warmup_epochs 5 --trainer.logger.name ETTh2_xlstm-mixer_96_42_ABL_G5_All_FSS_2_4 --trainer.logger.project xlstm-mixer --trainer.max_epochs 40 --seed_everything 42 --forecast_visualize_cb.pred_len 96 --forecast_visualize_cb.freq_epoch 1 --pruning_cb.target_sparsity 0.5 --pruning_cb.bank_size 4 --pruning_cb.warmup_epochs 10 --pruning_cb.blocks_only False --pruning_cb.target_modules weight,_recurrent_kernel_ --pruning_cb.exclude_keywords bias,norm
if %errorlevel% neq 0 (
