...
:: === Config: pred_len=96 (FSS 2:8 Sparsity 75% Seed 42) ===
:: 2:8模式：每8个元素保留2个，稀疏度75%
echo Running seed 42 (pred_len=96, FSS 2:8 sparsity)...
...
echo All FSS tasks (2:8 sparsity, Seed 42) completed successfully.
pause
