...
:: ============================================
:: 运行ETTm1数据集所有稀疏模式实验的主脚本
:: 包括：无稀疏、2:4、1:4、4:8、2:8
:: ============================================

echo ============================================
echo Starting All Sparsity Experiments for ETTm1
echo ============================================
echo.
...
echo ----------------------------------------
call "%~dp0run_ettm1_tasks_no_pruning.bat"
if %errorlevel% neq 0 (
...
echo ----------------------------------------
call "%~dp0run_ettm1_tasks_fss_2_4.bat"
if %errorlevel% neq 0 (
...
echo ----------------------------------------
call "%~dp0run_ettm1_tasks_fss_1_4.bat"
if %errorlevel% neq 0 (
...
echo ----------------------------------------
call "%~dp0run_ettm1_tasks_fss_4_8.bat"
if %errorlevel% neq 0 (
...
echo ----------------------------------------
call "%~dp0run_ettm1_tasks_fss_2_8.bat"
if %errorlevel% neq 0 (
...
set END_TIME=%time%
echo ============================================
echo All Experiments Completed for ETTm1!
echo ============================================
echo Start Time: %date% %START_TIME%
