...
NUM_WORKERS = "0"
OUTPUT_BAT_FILE = "run_weather_tasks.bat"
# =================================================
...
def generate_bat_script():
    ...
    configs = [
        ...
        {
            "pred_len": 96, "seq_len": 768, "batch_size": 64, "lr": 0.001,
            "xlstm_dropout": 0.25, "init_token": 2, "embedding_dim": 256,
            "num_heads": 8, "kernel_size": 0, "num_blocks": 1, 
            "gamma": 0.98, "cosine_epochs": 15, "warmup_epochs": 5, "const_gamma": 2
        },
        # Config 2: pred_len=192
        {
            "pred_len": 192, "seq_len": 512, "batch_size": 128, "lr": 0.1,
            "xlstm_dropout": 0.1, "init_token": 3, "embedding_dim": 256,
            "num_heads": 8, "kernel_size": 0, "num_blocks": 1, 
            "gamma": 0.98, "cosine_epochs": 15, "warmup_epochs": 5, "const_gamma": 2
        },
        # Config 3: pred_len=336
        {
            "pred_len": 336, "seq_len": 512, "batch_size": 128, "lr": 0.001,
            "xlstm_dropout": 0.1, "init_token": 1, "embedding_dim": 256,
            "num_heads": 8, "kernel_size": 0, "num_blocks": 1, 
            "gamma": 0.98, "cosine_epochs": 15, "warmup_epochs": 5, "const_gamma": 2
        },
        # Config 4: pred_len=720
        {
            "pred_len": 720, "seq_len": 768, "batch_size": 32, "lr": 0.001,
            "xlstm_dropout": 0.25, "init_token": 2, "embedding_dim": 128,
            "num_heads": 8, "kernel_size": 0, "num_blocks": 1, 
            "gamma": 0.98, "cosine_epochs": 15, "warmup_epochs": 5, "const_gamma": 2
        }
    ]
    ...
    for cfg in configs:
        ...
        for seed in SEEDS:
            ...
            lines.append("if %errorlevel% neq 0 (")
            lines.append("    echo ERROR: Command failed!")
            lines.append("    pause")
